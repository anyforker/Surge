...
| [`build-emby-rule-set.sh`](build-emby-rule-set.sh) | 聚合 Emby 精确域名并剔除宽泛匹配规则 | `rule/emby.list` |
...
- `rule/emby.list` 由 Emby 聚合脚本生成，补充条目维护在 `rule/emby-custom.list`。
